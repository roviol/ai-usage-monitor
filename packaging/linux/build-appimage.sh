...
ARCH=x86_64 "$appimagetool" "$appdir" "$root/$output_dir/AIUsageMonitor-0.3.0-x86_64.AppImage"
sha256sum "$root/$output_dir/AIUsageMonitor-0.3.0-x86_64.AppImage" > "$root/$output_dir/AIUsageMonitor-0.3.0-x86_64.AppImage.sha256"
