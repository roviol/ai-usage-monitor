...
- [ ] 2.3 Recheck the selected name immediately before remote creation and stop if it is unavailable
...
- [ ] 3.4 Create one initial commit with a concise message and verify that the worktree is clean

## 4. GitHub Publication

- [ ] 4.1 Create the GitHub repository under the authenticated owner with the selected name and visibility, configure `origin`, and push `main`
